...
public class Course{
    ...
    public void addStudent(Student student) {
        ...
        //System.out.println("Memasukkan mahasiswa " + student.getName() + "ke dalam mata kuliah " + courseName);
    ...
    public void removeStudent(Student student) {
        ...
        //System.out.println("Menghapus mahasiswa " + student.getName() + "dari mata kuliah " + courseName);
